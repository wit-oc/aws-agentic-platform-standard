...
Run ACP implementation work as deterministic initiative steps using the existing workspace initiative-runner contract.

## Initiative Artifact

- Path: `initiatives/aws-agentic-platform-acp-mvp-2026-03-07.md`
- Source of truth for:
  - task state,
  - progress evidence,
...
```text
[cron:<job-id> acp-mvp-Tn] Initiative runner turn for `initiatives/aws-agentic-platform-acp-mvp-2026-03-07.md`.
